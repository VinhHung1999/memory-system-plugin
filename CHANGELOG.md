...
### Changed
- Version bump only — bust plugin caches on client machines that pinned 1.10.5.

[memory-system 1.10.6]: https://github.com/VinhHung1999/memory-system-plugin/releases/tag/memory-system-v1.10.6
